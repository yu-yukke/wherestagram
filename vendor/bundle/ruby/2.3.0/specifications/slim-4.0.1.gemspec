...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<temple>, ["< 0.9", ">= 0.7.6"])
      s.add_runtime_dependency(%q<tilt>, ["< 2.1", ">= 2.0.6"])
    else
      s.add_dependency(%q<temple>, ["< 0.9", ">= 0.7.6"])
      s.add_dependency(%q<tilt>, ["< 2.1", ">= 2.0.6"])
    end
  else
    s.add_dependency(%q<temple>, ["< 0.9", ">= 0.7.6"])
    s.add_dependency(%q<tilt>, ["< 2.1", ">= 2.0.6"])
